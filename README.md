...
**All docker images with services listed above must be active.** These services are configured to start automatically and should not be stopped. Without active Traefik, e2c backed projects can't work properly. This option can be desable with: 
